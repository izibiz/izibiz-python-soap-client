...
from com.izibiz.invoice_xml.common import AdditionalDocumentReference, Attachment, EmbeddedDocumentBinaryObject
from com.izibiz.invoice_xml.common.ubl_common_aggregate_components_2_1 import Signature, SignatoryParty, PostalAddress, \
...
from com.izibiz.invoice_xml.common.ubl_common_basic_components_2_1 import PriceAmount, TaxAmount, Id, TaxableAmount, LineExtensionAmount, \
    TaxExclusiveAmount, TaxInclusiveAmount, AllowanceTotalAmount, ChargeTotalAmount, PayableAmount, InvoicedQuantity
from com.izibiz.invoice_xml.maindoc.ubl_invoice_2_1 import Invoice
