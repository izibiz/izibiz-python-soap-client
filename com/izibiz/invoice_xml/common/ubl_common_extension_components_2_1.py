...
from com.izibiz.invoice_xml.common.ubl_extension_content_data_type_2_1 import ExtensionContentType
from com.izibiz.invoice_xml.common.ubl_unqualified_data_types_2_1 import (
    CodeType,
    IdentifierType,
    TextType,
)
